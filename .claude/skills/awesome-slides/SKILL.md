...
- **No em dashes or en dashes, ever.** Keep the mid-sentence pivot, write it with a spaced hyphen: "Three things landed in the last 12 months - and combined, they collapse the time from idea to working agent by an order of magnitude."
