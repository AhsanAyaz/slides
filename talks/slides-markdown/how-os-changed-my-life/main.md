...
- For about 2.5 years <!-- .element class="fragment" -->
- Overcoming technical challenges and embracing learning opportunities <!-- .element class="fragment" -->
- Architecting and leading the team <!-- .element class="fragment" -->

;VS;

And this is how it looked...

![Good2beTrue](assets/images/how-os-changed-my-life/good2betrue.jpg) <!-- .element: style="height: 500px;" -->

;VS;

So 2.5 years of work and efforts

But at the end of it... <!-- .element class="fragment" -->

## The project never got live... <!-- .element class="fragment" -->

;VS;

![Scream](assets/images/how-os-changed-my-life/scream.png) <!-- .element: style="height: 500px;" -->
...
- The story behind my [first contribution](https://github.com/rpocklin/angular-timeline/pull/15)
...
![searchfail](assets/images/how-os-changed-my-life/search-fail.png) <!-- .element: style="height: 500px;" -->

;VS;

I could however find [ng-device-detector](https://github.com/srfrnk/ng-device-detector)

![ng-dd](assets/images/how-os-changed-my-life/ng-dd.png) <!-- .element: style="height: 500px; object-fit: contain;" -->
...
![maniac](assets/images/how-os-changed-my-life/laughing.png) <!-- .element: style="height: 500px;" class="fragment" -->

;VS;

![ngx-device-detector](assets/images/ngx-device-detector.png) <!-- .element: style="height: 500px;" -->
...
- Still below 500 stars on GitHub <!-- .element: class="fragment" -->
- Not all the code in the repository is mine <!-- .element: class="fragment" -->
...
## So we're not only consumers of tech, but also **creators & contributors** as well. <!-- .element: class="fragment" -->

;VS;

## And then I took the following steps:

- Started answering questions on stackoverflow <!-- .element: class="fragment" -->
- Convinced my company to make opensource contributions and tech talks as part of the company's culture <!-- .element: class="fragment" -->
- Started giving talks at small conferences <!-- .element: class="fragment" -->
...
![mashhood](assets/images/how-os-changed-my-life/mashhood.jpeg) <!-- .element: style="height: 500px;" -->
...
## And the brain said 'YES', why not?? <!-- .element: class="fragment" -->
...
## A couple of interviews later, I met Stephen Fluin for my final interview
...
![GDE](assets/images/how-os-changed-my-life/gde-success.png) <!-- .element: style="height: 500px;" -->
