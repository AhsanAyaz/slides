...
Google Developers Expert (GDE) <!-- .element: class="meme fragment" -->
...
###### Because Extermely Fast Career Growth doesn't ensure gaining Mastery <!-- .element: class="fragment" -->
...
- Involves Formal Change (job/title) <!-- .element: class="fragment" -->
...
- May or may not involve a job/title switch <!-- .element: class="fragment" -->
- Involves a change in Responsibilities <!-- .element: class="fragment" -->
...
![Oweseme Logo](assets/images/owesome-logo.png) <!-- .element: style="height: 400px; border-radius: 50%;" class="fragment" -->
...
- Nope <!-- .element: class="fragment" -->
- I could've used a team <!-- .element: class="fragment" -->
- I could've been more competent and experienced <!-- .element: class="fragment" -->
...
If you're not being promoted or not getting career advancement, that's not good. <!-- .element: class="fragment" -->

Avoid unnecessary career jumps or advancement. <!-- .element: class="fragment" -->
